...
//!
//! ### Contract Layer (`users_info-sdk`)
//! - **Location:** `examples/modkit/users_info/users_info-sdk/`
...
//! ## Public API
//!
//! The public API is defined in the `users_info-sdk` crate and re-exported here:
...
//! ## `OData` Support
//!
//! `OData` filter schemas live in `users_info-sdk::odata` (behind `odata` feature):
