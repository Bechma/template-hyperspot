...
use cf_users_info_sdk::{
    client::{AddressesStreamingClient, CitiesStreamingClient, UsersStreamingClient}, Address, City, NewAddress, NewCity, NewUser, UpdateAddressRequest,
    UpdateCityRequest, UpdateUserRequest, User, UserFull, UsersInfoClient,
    UsersInfoError,
};
